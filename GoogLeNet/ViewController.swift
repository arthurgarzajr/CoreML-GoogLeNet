...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var googleNetObject: UILabel!
    @IBOutlet weak var googleNetConfidence: UILabel!
    ...
    func myResultsMethod(request: VNRequest, error: Error?) {
        ...
        self.googleNetObject.text = "Object: " + (maxClassification?.identifier)!
        
        self.googleNetConfidence.text = "Confidence: " + String(describing: (maxClassification?.confidence)!)
    }
